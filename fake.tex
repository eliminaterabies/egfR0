...
\author{Michael Li, Katie Hampson, Ben Bolker and Jonathan Dushoff}
...
\\
Michael Li\textsuperscript{1*},
Katie Hampson\textsuperscript{2},
Benjamin M. Bolker\textsuperscript{1,3,4},
Jonathan Dushoff\textsuperscript{1,3,4}
\\
\\
\\
...
\\
\textbf{2} Institute of BAH\&CM, University of Glasgow, Glasgow, UK
\\
\textbf{3} Department of Mathematics and Statistics, McMaster University, Hamilton, Ontario, Canada
\\
\textbf{4} Institute for Infectious Diseases Research, McMaster University, Hamilton, Ontario, Canada
\\
\bigskip
...
\input{texknit/fakedoc.tex}

\singlespacing

\bmb{really, really unimportant, but: check for appropriate capitalization of PLOS? (PLoS?)}
