...
Black dashed lines show the means of each time-interval distribution; red dashed lines show the mean incubation period and generation interval (22.3 and 24.9 days, respectively) reported by \cite{hampson2009transmission}.
}
\flabel{GISI}
\end{figure}
\end{center}
