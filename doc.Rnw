...
\mr{Maybe this is the intent, but I experience some uncomfortable cognitive dissonance reading these two sentences... I think "apparent" is potentially confusing because even though $R_0\approx 1$ is what has been estimated, it is apparently not right?}
